...
public class Character : MonoBehaviour
{
    ...
    void Update()
    {
        if (Input.GetKeyDown(KeyCode.Mouse0) && RemainJump > 0) Jump(CharacterJumpPower);
    }
    ...
    void OnCollisionEnter2D(Collision2D col)
    {
        ...
        // ---------- TODO ---------- 
        if (col.gameObject.CompareTag("Platform")) RemainJump = MaxJump;
        else if (col.gameObject.CompareTag("Obstacle")) GM.GameOver();
        // -------------------- 
    }
